defmodule SymphonyElixir.StatusDashboard do
  ...
  defp format_project_link_lines do
    project_part =
      ...
      |> case do
        value when is_binary(value) and value != "" -> colorize(value, @ansi_cyan)
  ...
  defp tracker_project_label(%{kind: "linear", project_slug: project_slug})
       when is_binary(project_slug) and project_slug != "" do
    "https://linear.app/project/#{project_slug}/issues"
  end

  defp tracker_project_label(%{kind: "kaneo", project_id: project_id})
       when is_binary(project_id) and project_id != "" do
    "Kaneo project #{project_id}"
  end

  defp tracker_project_label(_tracker), do: nil
